			...
			<view class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
				...
				<view class="uni-list-item__content">
					...
					<view style="display: flex;">
						<text style="width: 50%" v-if="note" class="uni-list-item__content-note">{{ note }}</text>
						<text style="width: 50%" v-if="phone" class="uni-list-item__content-note">{{ phone }}</text>
					</view>
					<text v-if="address" class="uni-list-item__content-note">{{ address }}</text>
					<view style="display: flex;">
						<text style="width: 50%" v-if="weight" class="uni-list-item__content-note">{{ weight }}</text>
						<text style="width: 50%" v-if="postNum" class="uni-list-item__content-note">{{ postNum }}</text>
					</view>
				</view>
